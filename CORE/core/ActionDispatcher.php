...
class ActionDispatcher
{
    ...
    public function dispatch($action, $request)
    {
        ...
        // 🛡️ EXTRACCIÓN SOBERANA DE DATOS: 
        ...
        try {
                ...
                switch ($action) {
                    ...
                    case 'search_vault':
                        if (!isset($this->services['agente_restaurante'])) {
                            // 🏗️ INTENTO DE RECUPERACIÓN SOBERANA si no está cargado
            ...
            // 🛡️ ENVOLTURA SOBERANA: Si la respuesta no tiene el flag success, la envolvemos
