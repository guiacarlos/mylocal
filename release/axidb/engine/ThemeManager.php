<?php
/**
 * AxiDB - ThemeManager (legacy scaffold).
 *
...
class ThemeManager
{
    ...
    {
        //  RUTA SOBERANA: Los temas viven en el src del frontend
    ...
    {
        //  PROTECCIÓN SOBERANA: nunca borrar el tema por defecto
