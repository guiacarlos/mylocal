        ...
        switch ($type) {
            ...
            case 'category-grid':
                ...
                foreach ($cats as $cat) {
                    ...
                    $cIcon = htmlspecialchars($cat['icon'] ?? '', ENT_QUOTES, 'UTF-8');
            ...
            case 'menu-section':
                $cfg      = $element['config'] ?? [];
                $category = $cfg['category'] ?? '';
                $catIcon  = htmlspecialchars($cfg['categoryIcon'] ?? '', ENT_QUOTES, 'UTF-8');
                $showPrc  = $cfg['showPrice'] ?? true;
                $accent   = htmlspecialchars($cfg['accentColor'] ?? '#c4863a', ENT_QUOTES, 'UTF-8');
            ...
            case 'chef-special':
                ...
                $imgBlock = $pImg
                    ...
                    : "<div style=\"width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:4rem;background:#f9f5f0;\"></div>";
