<?php
/**
 * AxiDB - Motor de consulta sobre colecciones JSON.
 *
 * Subsistema: engine
 * Responsable: filtrado (where), ordenamiento (orderBy), paginacion (limit/offset)
 *              y busqueda de texto (search) sobre documentos leidos via StorageManager.
 * Notas:       en Fase 2 se extendera con los operadores que el Planner de
 *              AxiSQL necesita para compilar a llamadas de este motor.
 */
...
class QueryEngine
{
    ...
    public function query($collection, $params)
    {
        ...
        $items = $this->storage->list($collection);
